...
class QuadSceneCfg(InteractiveSceneCfg):
    ...
    # cartpole
    #robot: ArticulationCfg = HAMSTER_N_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class QuadEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the locomotion velocity-tracking environment."""

    # Scene settings
    scene: QuadSceneCfg = QuadSceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings
