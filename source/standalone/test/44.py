...
from omni.isaac.lab.terrains import TerrainGenerator ,TerrainGeneratorCfg, SubTerrainBaseCfg, TerrainImporterCfg

from omni.isaac.lab.terrains.trimesh.mesh_terrains import flat_terrain
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    sub_terrain_2_cfg = SubTerrainBaseCfg(
        function=flat_terrain,
        proportion=0.5,
        size=(5.0, 5.0),
    )
    ...
    sub_terrain = {
    "sub_terrain_1": sub_terrain_1_cfg,
    "sub_terrain_2": sub_terrain_2_cfg
}
    ...
    prim_utils.create_prim("/World/Terrain", "Xform")

    terrain_generator_cfg = TerrainGenerator(cfg=terrain_cfg)
    ...
    #terrain_generator = TerrainGenerator(cfg=terrain_import_cfg)
    terrain_mesh = terrain_generator_cfg.terrain_mesh
